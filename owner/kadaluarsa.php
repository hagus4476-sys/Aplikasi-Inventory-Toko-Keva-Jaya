...
// Ambang batas "segera kadaluarsa" (hari)
...
// ================= QUERY KADALUARSA =================
// Hanya barang dengan stok > 0 (baik biasa maupun besar) yang dipantau.
$query = "
    SELECT * FROM (
        SELECT
            b.id_barang,
...
<head>
    ...
    <title>Kadaluarsa — Keva Jaya (Owner)</title>
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Plus+Jakarta+Sans:wght@300;400;500;600;700&family=JetBrains+Mono:wght@400;500&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap-icons@1.11.3/font/bootstrap-icons.min.css">
    <style>
        /* ========== KEVA JAYA DESIGN SYSTEM (sama seperti admin) ========== */
        :root {
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .info-banner { display: flex; align-items: center; gap: 10px; padding: 10px 16px; background: var(--info-light); border: 1px solid #c5d9ef; border-radius: var(--radius); font-size: 13px; color: var(--info); margin-bottom: 20px; }
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul style="list-style:none;padding:0;">
            ...
            <li class="nav-item"><a href="kadaluarsa.php" class="nav-link active"><i class="bi bi-calendar-x"></i> Kadaluarsa</a></li>
        </ul>
    </nav>
...
<div class="main" id="main">
    ...
    <div class="page-body">
        ...
        <div class="alert alert-danger">
            <i class="bi bi-exclamation-circle-fill"></i>
            <strong><?= $total_kadaluarsa ?> barang</strong> sudah melewati tanggal kadaluarsa — segera tindak lanjuti (Admin dapat mengajukan Barang Rusak).
            <i class="bi bi-x alert-close" onclick="this.closest('.alert').remove()"></i>
        </div>
        ...
        <div class="info-banner">
            <i class="bi bi-eye"></i>
            Anda login sebagai <strong>Owner</strong>. Halaman ini hanya untuk monitoring. Untuk mengubah data kadaluarsa, hubungi Admin.
        </div>
