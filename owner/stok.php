...
// ================= LOGIKA STATUS STOK (SAMA DENGAN ADMIN) =================
...
<head>
    ...
    <title>Stok Barang — Keva Jaya (Owner)</title>
...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        <ul style="list-style:none;padding:0;">
            ...
            <li class="nav-item"><a href="stok.php" class="nav-link active"><i class="bi bi-boxes"></i> Stok Barang</a></li>
...
<div class="main" id="main">
    ...
    <div class="page-body">
        ...
        <div class="alert alert-info">
            ...
            <strong><?= $total_terjebak ?> barang</strong> karung utuhnya sudah habis, tapi masih ada sisa kiloan (dari karung yang sudah dibuka) — segera habiskan sisanya atau tambah stok karung baru.
            <i class="bi bi-x alert-close" onclick="this.closest('.alert').remove()"></i>
        </div>
        <?php endif; ?>
        ...
        <div class="info-banner">
            <i class="bi bi-eye"></i>
            Anda login sebagai <strong>Owner</strong>. Halaman ini hanya untuk monitoring. Untuk mengubah data stok, hubungi Admin.
        </div>
